 ...
 * Design: Dark charcoal background with card grid
 * Relationship-first approach, Ninja Selling philosophy (unnamed), genuine care
 * Section number watermark, scroll-triggered staggered cards
 */
...
const DIFFERENTIATORS = [
  ...
  },
  {
    ...
    description:
      "Born and raised in the region, I know these communities inside and out. You get hyper-local knowledge paired with a personal commitment to your success.",
  },
];
...
export default function Difference() {
  ...
  return (
    <section ref={ref} className="relative py-24 sm:py-32 lg:py-40 bg-charcoal/40 grain-overlay overflow-hidden">
          ...
          {DIFFERENTIATORS.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                initial="hidden"
                animate={isInView ? "visible" : "hidden"}
                className="group relative p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-background/60 border border-white/5 hover:border-maroon/30 transition-all duration-500"
              >
                <div className="flex items-start gap-4 sm:gap-5">
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-maroon/10 flex items-center justify-center group-hover:bg-maroon/20 transition-colors duration-500">
                  ...
                  <div>
                    ...
                    <p className="text-off-white/60 text-sm sm:text-base leading-relaxed">
                      {item.description}
                    </p>
                  </div>
                </div>
